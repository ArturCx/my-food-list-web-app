    ...
    <div className="flex flex-wrap items-center gap-2">
      <button
        ...
        className={cn(
          ...
          on ? "bg-blue-600 text-white shadow-[0_8px_20px_rgba(37,99,235,0.35)]" : "glass-soft hover:bg-white/85",
        )}
      >
        {on ? <Check /> : <Plus />}
      ...
      {selection.length > 0 && (
        <Link href="/rota" className="animate-in fade-in inline-flex min-h-11 items-center gap-1.5 rounded-[14px] px-3 text-[13px] font-bold text-blue-700 hover:underline">
